...
export class CustomerorderComponent implements OnInit {
  ...
  getProductById(productId: number) {
    ...
    this.http.get<any>('https://8080-dcabbfbbebfcfdadebbecffccbcffabaefd.project.examly.io/admin/getProductDetails/' + productId)
      .subscribe(
        (response: any) => {
  ...
  placeOrder() {
    ...
    if (this.orderForm.valid) {
      ...
      this.http.post('https://8080-dcabbfbbebfcfdadebbecffccbcffabaefd.project.examly.io/user/order/AddOrder',this.orderForm.value)
        .subscribe(
          (response: any) => {
