...
export class ViewpageComponent implements OnInit {
  ...
  type:String;
  products: any[];
  private baseUrl = 'https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin'
  ...
  searchGifts(filters: any): void {
    this.http.get<any[]>('https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin/giftfinder', { params: filters })
      .subscribe(response => {
        this.gifts = response;
      });
  }
