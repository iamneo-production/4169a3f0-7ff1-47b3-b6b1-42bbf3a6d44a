...
export class UserhomepageComponent implements OnInit {
  ...
  getDistinctOccasions(): void {
    this.http.get<String[]>('https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin/occasions')
      .subscribe(occasions => {
  ...
  getDistinctRecipient(): void {
    this.http.get<String[]>('https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin/recipient')
      .subscribe(recipient => {
  ...
  getBestSellers() {
    const url = 'https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin/best-sellers';
  ...
  loadNewestArrivalProducts() {
    const url = 'https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin/new-arrival'; 
  ...
  fetchTrendingItems() {
    this.http.get<Product[]>('https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin/trending').subscribe(
      (response) => {
  ...
  getFathersDayProducts() {
    ...
    this.http.get<any[]>('https://8080-abaaffbecfdadebbecffccbcffabaefd.project.examly.io/admin/fathers-day').subscribe(
        (response) => {
